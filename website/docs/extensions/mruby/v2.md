...
VitalRouter.MRuby uses [ChibiRuby](https://github.com/hadashiA/ChibiRuby) (formerly MRubyCS), a pure C# mruby VM implementation, from version 2 onwards.
Follow the steps below to install ChibiRuby-related packages and the VitalRouter.MRuby package.
...
2. Open the NuGet window by going to NuGet > Manage NuGet Packages, and install following packages.
  ...
  - VitalRouter.MRuby
3. Install the [ChibiRuby.Compiler](https://github.com/hadashiA/ChibiRuby) unity package (the Editor extension that adds the `.rb` / `.mrb` ScriptedImporter; it depends on the `ChibiRuby.Compiler` NuGet package installed in step 2).
...
:::note
ChibiRuby.Compiler is a package intended for use in build pipelines,
...
For details, see the [ChibiRuby.Compiler](https://github.com/hadashiA/ChibiRuby) documentation.
...
For details, see the [ChibiRuby.Serializer](https://github.com/hadashiA/ChibiRuby) documentation.
...
All [types supported by ChibiRuby.Serializer](https://github.com/hadashiA/ChibiRuby) are available as data values.
...
For details on the ChibiRuby API, see the [ChibiRuby](https://github.com/hadashiA/ChibiRuby) documentation.
...
2. Replace `MRubyContext` to `MRubyState`.
  ...
  - For details, see [ChibiRuby](https://github.com/hadashiA/ChibiRuby).
