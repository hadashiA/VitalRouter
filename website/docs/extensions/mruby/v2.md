...
See the next section for details on Ruby source code/bytecode conversion.
...
:::note
The `[MRubyObject]` attribute is provided by [MRubyCS.Serializer](https://github.com/hadashiA/MRubyCS?tab=readme-ov-file#mrubycsserializer)
:::
